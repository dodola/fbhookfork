...
// Determine if this library should be hooked.
                    ...
                    bool should_log_systrace(int fd, size_t count) {
                        return (
                                systrace_installed && fd == *atrace_marker_fd && count > 0);
                    }
...
// Returns the set of libraries that we don't want to hook.
            ...
            jboolean JNI_installSystraceHook(JNIEnv *, jobject) {
            ...
            jboolean JNI_isEnabled(JNIEnv *, jobject) {
...
//      });
                JNINativeMethod methods[] = {{"installSystraceHook",   "(I)Z", (void*)(JNI_installSystraceHook)},
                                             {"enableSystraceNative",  "()V",  (void*)(JNI_enableSystraceNative)},
                                             {"restoreSystraceNative", "()V",  (void*)(JNI_restoreSystraceNative)},
                                             {"isEnabled",             "()Z",  (void*)(JNI_isEnabled)}
                };
                registerNativeMethods(env, "com/facebook/profilo/provider/atrace/Atrace", methods,
